...
import { MergeContractsService } from "./merge-contracts/merge-contracts.service";

@Module({
  imports: [BlockchainConnectorsModule, WeweConfigModule, PriceOraclesModule, DatabaseModule],
  providers: [Logger, ArrakisContractsService, FeeManagerContractsService, Erc20Service, MergeContractsService],
  exports: [ArrakisContractsService, FeeManagerContractsService, Erc20Service, MergeContractsService],
})
